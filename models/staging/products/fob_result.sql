...
FROM `leslunes-prep.dbt_prod_gsheets.fob_suppliers`) AS A
#All transport modes
INNER JOIN
(SELECT country, 'air' AS type, air AS value FROM `leslunes-prep.dbt_prod_gsheets.fob_countries_transport_mode`
UNION ALL
SELECT country, 'sea' AS type, sea FROM `leslunes-prep.dbt_prod_gsheets.fob_countries_transport_mode`
UNION ALL
SELECT country, 'seaair' AS type, seaair FROM `leslunes-prep.dbt_prod_gsheets.fob_countries_transport_mode`
UNION ALL
SELECT country, 'truck' AS type, truck FROM `leslunes-prep.dbt_prod_gsheets.fob_countries_transport_mode`
UNION ALL
SELECT country, 'rail' AS type, rail FROM `leslunes-prep.dbt_prod_gsheets.fob_countries_transport_mode`
) AS B
ON A.country=B.country
CROSS JOIN
(SELECT * EXCEPT(id) FROM `leslunes-prep.dbt_prod_gsheets.fob_cat`) AS C
INNER JOIN
(SELECT * FROM `leslunes-prep.dbt_prod_gsheets.fob_countries_import_duty`) AS D
...
FROM `leslunes-prep.dbt_prod_gsheets.fob_shipments_tracking_cost` 
