...
FROM `leslunes-prep.dbt_marketing.geckoboard_metrics_de`
UNION ALL
...
FROM `leslunes-prep.dbt_marketing.geckoboard_metrics_fr`
UNION ALL
...
FROM `leslunes-prep.dbt_marketing.geckoboard_metrics_it`
